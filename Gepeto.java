...
// ------------------------------
    ...
    static class Stage {
    	...
    	static void trackfire(Gepeto r) {
    ...
    @FunctionalInterface private interface Consumer { void accept(Gepeto robo); }
